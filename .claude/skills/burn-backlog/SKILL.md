...
- **Budget awareness**: read `~/.local/state/claude-budget/mode` before each wave (missing file → `normal`); `conserve` shrinks wave size to 1 and downgrades planning to Opus.
