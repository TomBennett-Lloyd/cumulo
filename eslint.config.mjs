...
export default tseslint.config(
  {
    // Agent worktrees are gitignored, but eslint flat config does not read .gitignore
    // (Prettier 3 does — which is why format:check never hit this). Keep the explicit entry.
