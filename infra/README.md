...
| **On-demand capacity — everything else** (`sites` + both GSIs, `metrics`, `abuse`) | Same rates, request-shaped load — thousands of requests/month, and $0 while idle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **$0.00/mo**                                   |
