...
| Resource group                                                                     | Billing basis                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Estimate                                       |
| ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| **On-demand capacity — `series`** (the forecast fan-out's writes)                  | **Metered, no free allowance** since #258: $0.705/M write request units. Each cycle turns every location's horizon into forecast items — ~2,880/cycle at the canonical fleet, so `2,880 × 730` ≈ **2.10 M write units/month**. Reads bill at $0.1415/M: a dashboard load is ~25 units, thousands of loads to a cent — since #264 (actuals) and #296 (forecasts) those Queries are spent inside the API's two fleet routes rather than by a browser fan-out, which moved where they are issued and not how many. **$0 whenever the schedule is not running** — driven by the forecast stack's consumer (its DynamoDB row points here) and the api's reads (the api's own return row is pending — #243) | **≈ $1.48/mo** (≈ $4.99 at #29's 100-site cap) |
