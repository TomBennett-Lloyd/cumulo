...
14 WCU / 21 RCU against the Region's always-free 25 / 25 — `series` alone, since [issue #156](https://github.com/TomBennett-Lloyd/cumulo/issues/156) moved `weather` to on-demand and it stopped drawing on the pool.
...
| Resource group                                                                     | Billing basis                                                                                                                                                                                                                                                       | Estimate                                 |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| **Provisioned capacity** (`series` 14 WCU / 21 RCU)                                | 14 WCU / 21 RCU against the always-free **25 WCU / 25 RCU per Region**, which does not expire after twelve months                                                                                                                                                   | **$0.00/mo**                             |
| **On-demand capacity — `weather`** (the hourly cycle's writes)                     | **Metered, no free allowance**: $0.705/M write request units. Each cycle writes every location's 48-hour horizon, so `12 × 48 × 730` ≈ **0.42 M write units/month**. Reads bill at $0.1415/M and are noise beside that. **$0 whenever the schedule is not running** | **≈ $0.30/mo** (≈ $1.28 at 52 locations) |
